...
<html>
    ...
    <?php 
        ...
        if(isset($_POST['bor'])):
            ...
            $retbor = mysqli_query($db,"SELECT Title,ISBN,pubName 
                                    FROM book WHERE book.ISBN IN ( SELECT ISBN FROM borrows WHERE memberID='{$memberID}' AND date_of_return IS NULL); ");
